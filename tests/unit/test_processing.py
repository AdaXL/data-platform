...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_clean_and_convert_to_parquet(self, mock_os, mock_spark_session):
        ...
        # Run function
        clean_and_convert_to_parquet(input_path='data/test_raw', output_path='data/test_processed')
        ...
        self.assertTrue(mock_spark.read.csv.called, "Spark read.csv should have been called")
        
        # Check that write.parquet was called
        self.assertTrue(mock_df.write.mode.return_value.parquet.called, "DataFrame write.parquet should have been called")
